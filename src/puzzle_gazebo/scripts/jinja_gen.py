...
if __name__ == "__main__":
    ...
    parser.add_argument('--sdf_tag', default=True, type=str2bool, help="")
    parser.add_argument('--namespace', default="", help="Robot namespace for sdf file")
